// frontend/src/pages/Organization_notifications.jsx
...
export default function Organization_notifications() {
  ...
  const loadNotifications = async () => {
    ...
    setError(null);
    try {
      const res = await fetch(`${API}/notifications/organization`, {
  ...
  return (
    ...
    aria-label="Back to organization page"
  >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-sm text-gray-600">
              {filter === "unread" 
                ...
                : "Notifications about new complaints and updates will appear here."
              }
            </p>
          </div>
        ) : (
